...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="admin_dashboard.php?page=employees" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-semibold transition-colors duration-200">
            ...
            <table id="employeeTable" class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700">Chi Nhánh</th>
...
<script>
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('tableBody').innerHTML = 
                        '<tr class="text-center"><td colspan="8" class="text-muted">Không có dữ liệu</td></tr>';
                }
            })
            .catch(error => {
    ...
    function renderTable(employees) {
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center justify-center gap-3">
                            ...
                            <p class="text-gray-500 font-semibold">Không có nhân viên nào đã xóa</p>
                            <p class="text-gray-400 text-sm">Tất cả nhân viên đang hoạt động</p>
                        </div>
                    </td>
                </tr>
            `;
        ...
        document.getElementById('deletedCount').textContent = employees.length;
        ...
        tableBody.innerHTML = employees.map(emp => `
            <tr class="hover:bg-gray-50 transition-colors duration-150">
                ...
                <td class="px-6 py-4">
                    <span class="font-semibold text-gray-800">${emp.HO_TEN}</span>
                </td>
                <td class="px-6 py-4">
                    <span class="text-gray-600 text-sm">${emp.EMAIL}</span>
                </td>
                <td class="px-6 py-4">
                    <span class="text-gray-600 text-sm">${emp.TEN_CN}</span>
                </td>
                <td class="px-6 py-4">
                    <span class="text-gray-600 text-sm flex items-center gap-1">
                        <i class="fas fa-calendar-times text-red-500"></i>
                        ${new Date(emp.DELETED_AT).toLocaleDateString('vi-VN', { year: 'numeric', month: '2-digit', day: '2-digit' })}
                    </span>
                </td>
                <td class="px-6 py-4 text-center">
                    <button onclick="openRestoreModal('${emp.ID_TK}', '${emp.HO_TEN}')" class="inline-flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg font-semibold transition-colors duration-200 text-sm">
